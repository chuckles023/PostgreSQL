...
\copy skills_job_dim FROM '/Users/charles/Desktop/Work_Study/PostgreSQL/csv_files/skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
...
COPY company_dim
FROM '/Users/charles/Desktop/Work_Study/PostgreSQL/csv_files/company_dim.csv'
...
FROM '/Users/charles/Desktop/Work_Study/PostgreSQL/csv_files/job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM '/Users/charles/Desktop/Work_Study/PostgreSQL/csv_files/skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
